...
async function main() {
  console.log("Preparing to deploy the PowerUpNFT contract...");

  // --- Contract Constructor Arguments ---
  const initialMintPrice = parseEther("0.000013");
  ...
  const contractArtifact = await hre.artifacts.readArtifact("contracts/mintPowerUp.sol:BlastPowerUpNFT");
  ...
  console.log(`PowerUpNFT contract deployed to address: ${contractAddress}`);
