...
const tasks = [
  ...
  { title: 'Score 500+ in a day', description: 'Score over 500 points in one round of ENB Blast.', rewardPoints: 750, type: TaskType.DAILY, checkKey: 'HIGH_SCORE_500_PLUS' },
  ...
  { title: 'Use PowerUps', description: 'Mint and use Powerups a day.', rewardPoints: 1000, type: TaskType.DAILY, checkKey: 'HAS_USED_POWERUP' },
