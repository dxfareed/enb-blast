...
const tasks = [
  ...
  { title: 'Follow ENB on Luma', description: 'Stay updated with our events on Luma.', rewardPoints: 50, type: TaskType.DEFAULT, actionUrl: 'https://luma.com/user/usr-4S0qD2GzEnNzf2B', checkKey: 'LUMA_FOLLOW_ENB' },
  ...
  { title: 'Follow Founder on CreatorX', description: 'Follow and join the founder on CreatorX (onchain TikTok).', rewardPoints: 30, type: TaskType.DEFAULT, actionUrl: 'https://branch.creatorx.me/Zxuc0eJUgXb', checkKey: 'CREATORX_FOLLOW_FOUNDER' },
  ...
  { title: 'Use Multiplier', description: 'Double your score!', rewardPoints: 20, type: TaskType.DAILY, actionUrl: '/dashboard/game', checkKey: 'USE_MULTIPLIER' },
  ...
  { title: 'Claim Master', description: 'Use all your available claims for the day.', rewardPoints: 50, type: TaskType.DAILY, actionUrl: '/dashboard/game', checkKey: 'MAX_OUT_DAILY_CLAIMS' },
