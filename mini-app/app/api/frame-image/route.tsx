            ...
            <div style={{ width: '39%', display: 'flex', marginLeft:'50px'}}>
              <div style={{
                ...
                <div style={{ display: 'flex', width: '100%', gap: '15px' }}>
                  <StatItem label="Points" value={formatScore(parseFloat(displayUserProfile.weeklyPoints))} />
                  <StatItem
                    label={`Streak${displayUserProfile.streak <= 1 ? '' : 's'}`}
                    value={String(displayUserProfile.streak)}
                  />
                  <StatItem label="Claimed" value={formatScore(parseFloat(displayUserProfile.totalClaimed))} />
                </div>
              </div>
            </div>
